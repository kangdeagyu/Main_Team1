	...
	<div class="wrapper">
		...
		<form action="hide.do" method="post">
			<input type="hidden" name=fid value="${dto.fid }"> <input
				type="submit" name="action" value="숨김">
		</form>
			...
			<table border=1>
				...
				<c:forEach items="${reviewlist}" var="dto">
					<tr>
						...
						<td><a href="reviewInformation.do?fid=${dto.fid}">
								${dto.ftitle} </a></td>
						<td>
					...
					<tr id="productInfo-${dto.fid}" style="display: none;">
						<td colspan="7">
							...
							<p>주요정보</p>
							<p>상품사진</p> 
							<a href="productInformation.do?list=pname&query=${dto.pname}"><img src="${dto.pfilename}" alt="Product Image"
							width="100" /> </a>
							<table border="1">
								<tr>
									<td>상품번호</td>
