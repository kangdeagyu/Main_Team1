...
<script>
 ...
 // 임시 데이터 배열
    var tempData = [
        ...
        { id: 12, name: "Product 12", price: 1000 },
        { id: 13, name: "Product 13", price: 1000 },
        { id: 14, name: "Product 14", price: 1000 },
        { id: 15, name: "Product 15", price: 1000 },
        { id: 16, name: "Product 16", price: 1000 },
        { id: 17, name: "Product 17", price: 1000 },
        { id: 18, name: "Product 18", price: 1000 },
        { id: 19, name: "Product 19", price: 1000 },
        { id: 20, name: "Product 20", price: 1000 },
        { id: 21, name: "Product 21", price: 1000 },
        { id: 22, name: "Product 22", price: 1000 },
        { id: 23, name: "Product 23", price: 1000 },
        { id: 24, name: "Product 24", price: 1000 },
        { id: 25, name: "Product 25", price: 1000 },
        { id: 26, name: "Product 26", price: 1000 },
        { id: 27, name: "Product 27", price: 1000 },
        { id: 28, name: "Product 28", price: 1000 },
        { id: 29, name: "Product 29", price: 1000 }
    ];
